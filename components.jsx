...
function LangSplash({ onPick }) {
  ...
  const langs = [
    ...
    { code: "id", flag: "🇮🇩", name: "Bahasa Indonesia", native: "الإندونيسية" },
    { code: "fr", flag: "🇫🇷", name: "Français", native: "الفرنسية" },
    { code: "tr", flag: "🇹🇷", name: "Türkçe", native: "التركية" },
    { code: "ms", flag: "🇲🇾", name: "Bahasa Melayu", native: "الملايوية" },
  ];
  return (
    ...
    <header className="site-header" data-screen-label="Header">
      <div className="header-inner">
        ...
        <div className="header-tools">
          <button className="tool-btn" onClick={onChangeLang} title="language">
...
function FestivalMap({ t }) {
  ...
  const zones = [
    ...
    { key: "families",  fill: "rgba(184,137,90,0.9)",  border: "rgba(150,100,50,1)", label: "الأسر\nالمنتجة",
    ...
    { key: "families2", fill: "rgba(184,137,90,0.9)",  border: "rgba(150,100,50,1)", label: "الأسر\nالمنتجة",
      linkTo: "families",
      labelStyle: { whiteSpace: "pre-line", lineHeight: "1.1", fontSize: "0.6rem", fontWeight: 900 },
      ...
      <div className="container">
        ...
        <div className="map-wrap">
          <div className="park-map">
            <img src="assets/park-satellite.png" alt="الحديقة العامة — صورة جوية" className="park-map-bg"/>
...
// ========== Offer ==========
function Offer({ t }) {
  const offerItems = t.offer.items.slice(0, 2);
  return (
            ...
            <article className={"offer-card reveal d" + ((i%3)+1)} key={i}>
              {it.img ? (
                <div className="offer-thumb">
                  ...
                  {it.badge ? <span className="offer-tag">{it.ic} {it.badge}</span> : null}
                </div>
              ) : (
...
function Events({ t }) {
  ...
  const event = t.events.list.find(e => e.day === day) || t.events.list[0];
  const eventDayLabel = t.events.days[Math.max(0, day - 1)] || "";
  return (
      ...
      <div className="container">
        ...
        <div className="events-ctrls">
          {t.events.list.map((e, i) => (
            <button
              key={e.day}
              className={"day-pill" + (day === e.day ? " active" : "")}
              onClick={() => setDay(e.day)}>
              <b>{e.day}</b>
              <span>{t.events.days[i]}</span>
            </button>
          ))}
        </div>
        <article className="event-card" key={day}>
          ...
          <div className="event-body">
            <h3>{event.title}</h3>
            <div className="event-date-line">{eventDayLabel} - {event.date}</div>
            <div className="meta">
              <span>
...
function Location({ t }) {
  ...
  const mapsUrl = "https://www.google.com/maps/search/?api=1&query=" + encodeURIComponent("الحديقة العامة القنفذة");
  const dirUrl = "https://www.google.com/maps/dir/?api=1&destination=" + encodeURIComponent("الحديقة العامة القنفذة");
    ...
    <section id="location" className="section" data-screen-label="Location">
      <div className="container">
        ...
        <div className="loc-grid">
          ...
          <iframe className="loc-map" title="map" loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
            src="https://www.google.com/maps?q=الحديقة العامة القنفذة&output=embed"/>
        </div>
        ...
        <div className="share-box">
          ...
          <div className="share-grid">
            ...
            <a className="share-btn wa" target="_blank" rel="noopener" title="WhatsApp"
            ...
            <a className="share-btn x" target="_blank" rel="noopener" title="X"
            ...
            <button className="share-btn ig" onClick={() => handlePlatformOpen("https://www.instagram.com/")} title="Instagram">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/>
              </svg>
            </button>
            <button className="share-btn snap" onClick={() => handlePlatformOpen("https://www.snapchat.com/")} title="Snapchat">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
            ...
            <button className="share-btn cp" onClick={handleCopy} title="Copy link">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2">
